 ...
 * Generated at: 2021-12-14 17:04:29 UTC
...
public final class muutavene_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Muuta venettä</title>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("				<th colspan=\"3\" class=\"oikealle\"><a href=\"listaaveneet.jsp\" id=\"takaisin\">Takaisin listaukseen</a></th>\r\n");
      out.write("			</tr>		\r\n");
      out.write("			<tr>\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("document.getElementById(\"nimi\").focus();//viedään kursori Nimi-kenttään sivun latauksen yhteydessä\r\n");
      out.write("\r\n");
      out.write("//Haetaan muutettavan veneen tiedot. Kutsutaan backin GET-metodia ja välitetään kutsun mukana muutettavan veneen tunnus\r\n");
      out.write("//GET /veneet/haeyksi/tunnus\r\n");
      out.write("var tunnus = requestURLParam(\"tunnus\"); //Funktio löytyy scripts/main.js \r\n");
      out.write("fetch(\"veneet/haeyksi/\" + tunnus,{//Lähetetään kutsu backendiin\r\n");
      ...
      out.write("\r\n");
      out.write("	document.getElementById(\"tunnus\").value = responseJson.tunnus;\r\n");
      out.write("	document.getElementById(\"nimi\").value = responseJson.nimi.replace(/&nbsp;/g, ' ');	//muokataan syötekenttään välilyönti takaisin\r\n");
      out.write("	document.getElementById(\"merkkimalli\").value = responseJson.merkkimalli.replace(/&nbsp;/g, ' '); //samoin tähän kenttään\r\n");
      out.write("	document.getElementById(\"pituus\").value = responseJson.pituus;	\r\n");
      out.write("	document.getElementById(\"leveys\").value = responseJson.leveys;\r\n");
      out.write("	document.getElementById(\"hinta\").value = responseJson.hinta;\r\n");
      out.write("	});	\r\n");
      out.write("\r\n");
      ...
      out.write("	var pituus = siivoa(document.getElementById(\"pituus\").value); //korvataan syötteen merkki ennen validointia\r\n");
      out.write("	var leveys = siivoa(document.getElementById(\"leveys\").value); \r\n");
      out.write("	var hinta = document.getElementById(\"hinta\").value;\r\n");
      out.write("	\r\n");
      out.write("	if(nimi.length<2||merkkimalli.length<2||pituus*1!=pituus||leveys*1!=leveys||hinta*1!=hinta){ //validoidaan arvot, luvut kerrotaan itsellään lu\r\n");
      out.write("		document.getElementById(\"ilmo\").innerHTML = \"Antamasi arvot eivät kelpaa!\"\r\n");
      out.write("		return;\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	if(ilmo!=\"\"){\r\n");
      ...
      out.write("	fetch(\"veneet\",{//Lähetetään kutsu backendiin\r\n");
