...
document.getElementById("nimi").focus();//viedään kursori nimikenttään sivun latauksen yhteydessä
...
function lisaaTiedot(){	
	...
	var pituus = siivoa(document.getElementById("pituus").value); //korvataan syötteen merkki ennen validointia, jotta voidaan laskea
	var leveys = siivoa(document.getElementById("leveys").value); 
	var hinta = document.getElementById("hinta").value;
	
	if(nimi.length<2||merkkimalli.length<2||pituus*1!=pituus||leveys*1!=leveys||hinta*1!=hinta){ //validoidaan arvot, luvut kerrotaan itsellään numeraalisen arvon varmistamiseksi
